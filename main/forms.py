...
class review(FlaskForm):
    ...
    review = StringField('Review', validators=[DataRequired(), Length(min=20, max=300)])
    stars = IntegerField('Stars', validators=[DataRequired(), NumberRange(min=0, max=5)], default=0)
